...
with st.form("Pilot Coating Process Form"):
    solution_id = st.text_input("Solution ID")
    ...
    if submitted:
        ...
        pcp_sheet.append_row([
            pcoating_id, solution_id, date.strftime("%Y-%m-%d"), box_temperature, box_rh,
...
with st.form("Dip Coating Process Form"):
    ...
    if submitted:
        ...
        dcp_sheet.append_row([
            dcoating_id, solution_id, date.strftime("%Y-%m-%d"), box_temperature, box_rh,
            n2_flow, number_of_fibers, coating_speed, annealing_time, annealing_temp,
...
with st.form("Coating Solution Mass Form"):
    ...
    if submitted:
        ...
        csm_sheet.append_row([
            solution_mass_id, solution_id, date_time.strftime("%Y-%m-%d"),
            selected_dcoating_id, selected_pcoating_id, solution_mass,
            operators_initials, notes])
